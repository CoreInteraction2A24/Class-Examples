...
const init = () => {
  ...
  */
  ...
  let wrapper = document.getElementById(story_container);
  let mouse_info = document.getElementById(mouse_position_container);

  wrapper.addEventListener("mousemove", function (ev) {


    let mouseRadius = mouse_info.clientWidth/2;
